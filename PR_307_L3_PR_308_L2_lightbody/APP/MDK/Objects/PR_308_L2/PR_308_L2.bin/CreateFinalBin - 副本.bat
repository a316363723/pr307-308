...
..\..\File_Merge.exe boot_and_app_and_basedata.bin security_ota.bin %UPDATE_AREA_OFFSET% "%ProductName%_HardwareV%HardVer_Float%_SoftwareV%SoftVer_Float%.bin" >nul
