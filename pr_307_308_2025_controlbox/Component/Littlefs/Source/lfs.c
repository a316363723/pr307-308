...
//static __INLINE void lfs_pair_swap(lfs_block_t pair[2]) {
//    lfs_block_t t = pair[0];
//    pair[0] = pair[1];
//    pair[1] = t;
//}

//static __INLINE bool lfs_pair_isnull(const lfs_block_t pair[2]) {
//    return pair[0] == 0xffffffff || pair[1] == 0xffffffff;
//}

//static __INLINE int lfs_pair_cmp(
...
//static __INLINE bool lfs_pair_sync(
//        const lfs_block_t paira[2],
//        const lfs_block_t pairb[2]) {
//    return (paira[0] == pairb[0] && paira[1] == pairb[1]) ||
//           (paira[0] == pairb[1] && paira[1] == pairb[0]);
...
//static __INLINE void lfs_pair_fromle32(lfs_block_t pair[2]) {
//    pair[0] = lfs_fromle32(pair[0]);
//    pair[1] = lfs_fromle32(pair[1]);
//}

//static __INLINE void lfs_pair_tole32(lfs_block_t pair[2]) {
...
//static __INLINE bool lfs_tag_isvalid(lfs_tag_t tag) {
//    return !(tag & 0x80000000);
//}

//static __INLINE bool lfs_tag_isdelete(lfs_tag_t tag) {
//    return ((int32_t)(tag << 22) >> 22) == -1;
//}

//static __INLINE uint16_t lfs_tag_type1(lfs_tag_t tag) {
//    return (tag & 0x70000000) >> 20;
//}

//static __INLINE uint16_t lfs_tag_type3(lfs_tag_t tag) {
//    return (tag & 0x7ff00000) >> 20;
//}

//static __INLINE uint8_t lfs_tag_chunk(lfs_tag_t tag) {
//    return (tag & 0x0ff00000) >> 20;
//}

//static __INLINE int8_t lfs_tag_splice(lfs_tag_t tag) {
//    return (int8_t)lfs_tag_chunk(tag);
//}

//static __INLINE uint16_t lfs_tag_id(lfs_tag_t tag) {
//    return (tag & 0x000ffc00) >> 10;
//}

//static __INLINE lfs_size_t lfs_tag_size(lfs_tag_t tag) {
//    return tag & 0x000003ff;
//}

//static __INLINE lfs_size_t lfs_tag_dsize(lfs_tag_t tag) {
...
//static __INLINE void lfs_gstate_xor(struct lfs_gstate *a,
...
//static __INLINE bool lfs_gstate_iszero(const struct lfs_gstate *a) {
//    for (int i = 0; i < 3; i++) {
//        if (((uint32_t*)a)[i] != 0) {
//            return false;
//        }
...
//static __INLINE bool lfs_gstate_hasorphans(const struct lfs_gstate *a) {
//    return lfs_tag_size(a->tag);
//}

//static __INLINE uint8_t lfs_gstate_getorphans(const struct lfs_gstate *a) {
//    return lfs_tag_size(a->tag);
//}

//static __INLINE bool lfs_gstate_hasmove(const struct lfs_gstate *a) {
//    return lfs_tag_type1(a->tag);
//}

//static __INLINE bool lfs_gstate_hasmovehere(const struct lfs_gstate *a,
//        const lfs_block_t *pair) {
//    return lfs_tag_type1(a->tag) && lfs_pair_cmp(a->pair, pair) == 0;
//}

//static __INLINE void lfs_gstate_xororphans(struct lfs_gstate *a,
//        const struct lfs_gstate *b, bool orphans) {
//    a->tag ^= LFS_MKTAG(0x800, 0, 0) & (b->tag ^ (orphans << 31));
//}

//static __INLINE void lfs_gstate_xormove(struct lfs_gstate *a,
...
//static __INLINE void lfs_gstate_fromle32(struct lfs_gstate *a) {
//    a->tag     = lfs_fromle32(a->tag);
//    a->pair[0] = lfs_fromle32(a->pair[0]);
//    a->pair[1] = lfs_fromle32(a->pair[1]);
//}

//static __INLINE void lfs_gstate_tole32(struct lfs_gstate *a) {
...
//static __INLINE void lfs_superblock_fromle32(lfs_superblock_t *superblock) {
...
//static __INLINE void lfs_superblock_tole32(lfs_superblock_t *superblock) {
...
//        
////--------------------------------------------
////__align(8) uint8_t cache_buf[LFS_CFG_FILE_LEN] = {0};
////--------------------------------------------

//int lfs_file_open(lfs_t *lfs, lfs_file_t *file,
//        const char *path, int flags) {
////    static const struct lfs_file_config defaults = {.buffer = cache_buf,};
...
/////// Metadata pair and directory operations ///
//static __INLINE lfs_size_t lfs1_entry_size(const lfs1_entry_t *entry) {
