...
{
	memmove(item, (uint8_t*)fifo->itemspace + fifo->readoffset, fifo->itemsize);
...
{
	memmove((uint8_t*)fifo->itemspace + fifo->writeoffset, item, fifo->itemsize);
