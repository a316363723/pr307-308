...
//#include "../../../../../../UI/preset_task_item.h"
//#include "../../../../../../UI/menu_item_obj.h"
...
//    else if (lv_obj_check_type(obj, &preset_task_item_obj_class)) {
//        lv_obj_add_style(obj, &styles->btn, 0);
//    }
//    else if (lv_obj_check_type(obj, &menu_item_obj_obj_class)) {
//        lv_obj_add_style(obj, &styles->btn, 0);
//    }
